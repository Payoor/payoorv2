...
router.post('/checkout-service/create/checkout', _authMiddleware["default"], /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    var userId, items, productIds, objectIdProductIds, productVariants, productPriceMap, subTotal, _yield$Promise$all, _yield$Promise$all2, rawDeliveryFee, rawServiceCharge, deliveryDates, delivery_fee, service_charge, serviceCharge, finalTotal, delivery_date, phone_number, delivery_address, roundedFinalTotal, newCheckoutDocument;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 10:
          ...
          subTotal = Array.from(productPriceMap.values()).reduce(function (accumulator, item) {
            return accumulator + item.price * item.amount;
          }, 0);
          subTotal = Number(subTotal);
          _context.next = 18;
          return Promise.all([_RedisManager["default"].hget('admindirective', 'deliveryfee'), _RedisManager["default"].hget('admindirective', 'servicecharge')
          //Checkout.findOne({ user_id: userId }).sort({ created_at: -1 }).lean()
          ]);
        case 18:
          _yield$Promise$all = _context.sent;
          _yield$Promise$all2 = _slicedToArray(_yield$Promise$all, 2);
          rawDeliveryFee = _yield$Promise$all2[0];
          rawServiceCharge = _yield$Promise$all2[1];
          ...
          delivery_date = deliveryDates[2];
          phone_number = '0';
          delivery_address = 'add a valid address';
          roundedFinalTotal = Math.round(finalTotal);
