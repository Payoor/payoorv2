 ...
 */
var createDummyCoupons = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          count = _args.length > 0 && _args[0] !== undefined ? _args[0] : 10;
          couponPromises = [];
          affiliateEmails = ['affiliate1@example.com', 'affiliate2@example.com'];
          console.log("Creating ".concat(count, " dummy coupons..."));
          for (i = 0; i < count; i++) {
            isAffiliateCoupon = Math.random() > 0.5; // 50% chance of having an affiliate
            hasPercentageOff = Math.random() > 0.5; // 50% chance of a percentage discount
            // Create an object for the new coupon
            newCouponData = {
              name: "Dummy Coupon ".concat(i + 1),
            ...
            newCoupon = new _Coupon["default"](newCouponData);
        ...
        case 8:
          ...
          console.log("Successfully created ".concat(results.length, " coupons."));
          return _context.abrupt("return", results);
        case 13:
          _context.prev = 13;
          _context.t0 = _context["catch"](5);
          console.error('Error creating dummy coupons:', _context.t0);
          throw _context.t0;
        case 17:
        case "end":
  ...
  return function createDummyCoupons() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 5:
          ...
          console.error('Failed to run coupon creation script:', _context2.t0);
        case 8:
          _context2.prev = 8;
