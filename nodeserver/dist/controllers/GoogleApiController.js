...
var client = new _googleMapsServicesJs.Client({});
if (process.env.NODE_ENV !== 'production') {
  require("dotenv").config();
}
var GoogleApiController = /*#__PURE__*/function () {
  function GoogleApiController() {
    _classCallCheck(this, GoogleApiController);
  }
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return _axios["default"].get("https://maps.googleapis.com/maps/api/place/textsearch/json?query=".concat(req.query.query, "&region=ng&components=country:ng&key=").concat(process.env.GOOGLE_MAPS_API_KEY));
            case 3:
              placesResponse = _context.sent;
              filteredResults = placesResponse.data.results.map(function (place) {
                return {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 4:
              ...
              filteredResults = geocodeResponse.data.results.map(function (place) {
                return {
                  formatted_address: place.formatted_address,
                  icon: place.icon
                };
...
var _default = exports["default"] = new GoogleApiController();