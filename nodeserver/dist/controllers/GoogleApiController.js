...
class GoogleApiController {
  async searchPlaces(req, res, next) {
    try {
      const placesResponse = await _axios.default.get(`https://maps.googleapis.com/maps/api/place/textsearch/json?query=${req.query.query}&region=ng&components=country:ng&key=${process.env.GOOGLE_MAPS_API_KEY}`);
