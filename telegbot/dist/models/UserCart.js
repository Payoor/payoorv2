...
UserCartSchema.methods.calculateTotal = function () {
  var _this = this;
  var total = 0;
  this.totalItems.map(/*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(item_id) {
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          ...
          case 1:
            variant = _context.v;
            itemTotal = _this.items[item_id] * variant.price;
