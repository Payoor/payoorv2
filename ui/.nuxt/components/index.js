...
export const AddressesList = () => import('../../components/AddressesList.vue' /* webpackChunkName: "components/addresses-list" */).then(c => wrapFunctional(c.default || c))
export const AdminHeader = () => import('../../components/AdminHeader.vue' /* webpackChunkName: "components/admin-header" */).then(c => wrapFunctional(c.default || c))
export const AdminProductsTable = () => import('../../components/AdminProductsTable.vue' /* webpackChunkName: "components/admin-products-table" */).then(c => wrapFunctional(c.default || c))
export const AdminUiHeader = () => import('../../components/AdminUiHeader.vue' /* webpackChunkName: "components/admin-ui-header" */).then(c => wrapFunctional(c.default || c))
...
export const EditableItemTable = () => import('../../components/EditableItemTable.vue' /* webpackChunkName: "components/editable-item-table" */).then(c => wrapFunctional(c.default || c))
...
export const NewItemForm = () => import('../../components/NewItemForm.vue' /* webpackChunkName: "components/new-item-form" */).then(c => wrapFunctional(c.default || c))
...
export const VariantProductsTable = () => import('../../components/VariantProductsTable.vue' /* webpackChunkName: "components/variant-products-table" */).then(c => wrapFunctional(c.default || c))
