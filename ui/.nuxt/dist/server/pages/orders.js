...
module.exports.__inject__ = function (context) {
  add("716ef1f2", content, true, context)
};
...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_orders_vue_vue_type_style_index_0_id_2beedc61_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(125);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_orders_vue_vue_type_style_index_0_id_2beedc61_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_orders_vue_vue_type_style_index_0_id_2beedc61_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_orders_vue_vue_type_style_index_0_id_2beedc61_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_orders_vue_vue_type_style_index_0_id_2beedc61_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, "*[data-v-2beedc61],[data-v-2beedc61]:after,[data-v-2beedc61]:before{box-sizing:inherit;margin:0;padding:0}html[data-v-2beedc61]{background:#249b48;font-size:62.5%}@media only screen and (max-width:75em){html[data-v-2beedc61]{font-size:56.25%}}@media only screen and (max-width:56.25em){html[data-v-2beedc61]{font-size:55%}}@media only screen and (max-width:37.5em){html[data-v-2beedc61]{font-size:50%}}@media only screen and (min-width:112.5em){html[data-v-2beedc61]{font-size:65%}}body[data-v-2beedc61]{background:#249b48;box-sizing:border-box;display:none;font-family:\"Poppins\",sans-serif}@media only screen and (max-width:56.25em){body[data-v-2beedc61]{padding:0}}[data-v-2beedc61]::-moz-selection{background-color:#249b48;color:#fff}[data-v-2beedc61]::selection{background-color:#249b48;color:#fff}[data-v-2beedc61]::-webkit-scrollbar{height:8px;width:8px}[data-v-2beedc61]::-webkit-scrollbar-track{background:transparent}[data-v-2beedc61]::-webkit-scrollbar-thumb{background-color:#249b48;border:none;border-radius:10px}[data-v-2beedc61]::-webkit-scrollbar-thumb:hover{background-color:#1a7235}*[data-v-2beedc61]{scrollbar-color:#249b48 transparent;scrollbar-width:thin}@keyframes slideFadeInUp-2beedc61{0%{opacity:0;transform:translateY(20px)}to{opacity:1;transform:translateY(0)}}@keyframes slide-in-left-2beedc61{0%{opacity:0;transform:translateX(-100%)}to{opacity:1;transform:translateX(0)}}@keyframes float-2beedc61{0%{transform:translateY(0)}50%{transform:translateY(-10px)}to{transform:translateY(0)}}@keyframes spin-2beedc61{to{transform:rotate(1turn)}}.slide-in-left[data-v-2beedc61]{animation:slide-in-left-2beedc61 .5s ease-out forwards}.button-primary[data-v-2beedc61]{background:#249b48;border:none;border-radius:1rem;color:#fff;font-weight:500;outline:none;padding:1rem}.transparent-button[data-v-2beedc61]{background:transparent;border:1px solid #249b48;color:#249b48}.disabled-btn[data-v-2beedc61]{opacity:.4}.floating-element[data-v-2beedc61]{animation:float-2beedc61 3s ease-in-out infinite;animation-delay:0s;transition:transform .2s ease}.no-scroll[data-v-2beedc61]{height:100vh!important;overflow:hidden!important}.spinner[data-v-2beedc61]{animation:spin-2beedc61 1s linear infinite;border:4px solid rgba(36,155,72,.3);border-radius:50%;border-top-color:#249b48;height:3rem;width:3rem}.spinner.path[data-v-2beedc61]{stroke:#249b48;stroke-linecap:round}.blur-effect[data-v-2beedc61]{filter:blur(3px)}.landing[data-v-2beedc61]{overflow-x:hidden}.landing__top[data-v-2beedc61]{background:#b6edf2;display:grid;grid-template-columns:repeat(2,1fr);height:100vh;left:0;position:fixed;top:0;width:100%}@media only screen and (max-width:56.25em){.landing__top[data-v-2beedc61]{display:flex}}.landing__topleft[data-v-2beedc61]{display:flex;justify-content:center}@media only screen and (max-width:56.25em){.landing__topleft[data-v-2beedc61]{display:block;width:100%}}.landing__topleft--auth[data-v-2beedc61]{padding:0 10rem;width:100rem}@media only screen and (max-width:56.25em){.landing__topleft--auth[data-v-2beedc61]{padding:0;width:auto}}.landing__topright[data-v-2beedc61],.landing__topright--img[data-v-2beedc61]{align-items:center;display:flex;justify-content:center}.landing__topright--img[data-v-2beedc61]{transform:scale(1.1);width:100rem}.landing__topright--img img[data-v-2beedc61]{height:100%;-o-object-fit:contain;object-fit:contain;width:100%}@media only screen and (max-width:56.25em){.landing__topright[data-v-2beedc61]{display:none}}.landing__content[data-v-2beedc61]{background:#249b48;margin-top:90rem;position:relative}.landing__seemore[data-v-2beedc61]{bottom:10rem;display:flex;justify-content:center;left:0;position:absolute;width:100%}.landing__seemore button[data-v-2beedc61]{background:transparent;border:1px solid #fff;border-radius:3rem;color:#fff;cursor:pointer;font-size:1.4rem;font-weight:600;padding:1rem 4rem}.landing__cloud[data-v-2beedc61]{bottom:0;height:34rem;position:absolute;transform:scale(1.1);width:100vw;z-index:3}.landing__cloud img[data-v-2beedc61]{height:100%;-o-object-fit:cover;object-fit:cover;width:100%}.orders__header[data-v-2beedc61]{left:0;position:fixed;top:0;width:100vw;z-index:6}.orders__header.auth[data-v-2beedc61],.orders__header.unauth[data-v-2beedc61]{background:transparent}@media only screen and (max-width:56.25em){.orders__header.auth[data-v-2beedc61]{background:#fff}}.orders__content[data-v-2beedc61]{align-items:center;background:#fff;display:flex;flex-direction:column;min-height:100vh;padding-bottom:20rem;padding-top:4rem;position:relative}@media only screen and (max-width:37.5em){.orders__content[data-v-2beedc61]{display:block;padding:7rem 1rem 30rem}}.orders__content--body[data-v-2beedc61]{width:60rem}@media only screen and (max-width:56.25em){.orders__content--body[data-v-2beedc61]{width:100%}}.orders__empty[data-v-2beedc61]{color:#777;font-size:1.3rem;padding:2rem;text-align:center}.order-card[data-v-2beedc61]{background:#fafafa;border:1px solid #e2e2e2;border-radius:1rem;margin-bottom:2rem;padding:1rem}.order-card__header[data-v-2beedc61]{align-items:center;cursor:pointer;display:flex;flex-wrap:wrap;justify-content:space-between}.order-card__header p[data-v-2beedc61]{font-size:1.5rem;margin:.5rem 0}.order-card__header .toggle-btn[data-v-2beedc61]{background:none;border:none;color:#007bff;cursor:pointer;font-weight:700}.order-card__togglecart[data-v-2beedc61]{border:none;color:#249b48;font-size:1.4rem;font-weight:600}.order-card__loading[data-v-2beedc61]{align-items:center;display:flex;justify-content:center;padding:5rem 0}.fade-enter-active[data-v-2beedc61],.fade-leave-active[data-v-2beedc61]{transition:all .3s ease}.fade-enter-from[data-v-2beedc61],.fade-leave-to[data-v-2beedc61]{opacity:0;transform:translateY(-5px)}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/orders.vue?vue&type=template&id=2beedc61&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "orders"
  }, [_vm._ssrNode("<div class=\"orders__header\" data-v-2beedc61>", "</div>", [_vm._ssrNode("<div class=\"chatcart__header\" data-v-2beedc61>", "</div>", [_c('ChatHeader', {
    attrs: {
      "name": 'Your Orders',
      "logovisible": false,
      "jwt": true,
  ...
  })], 1)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"orders__content\" data-v-2beedc61>", "</div>", [_vm._ssrNode("<div class=\"orders__content--body\" data-v-2beedc61>", "</div>", [_vm.loading ? _vm._ssrNode("<div class=\"orders__loading\" data-v-2beedc61>", "</div>", [_c('LoadingAnimation')], 1) : _vm.orders.length === 0 ? _vm._ssrNode("<div class=\"orders__empty\" data-v-2beedc61><p data-v-2beedc61>You haven’t placed any orders yet.</p></div>") : _vm._ssrNode("<div data-v-2beedc61>", "</div>", _vm._l(_vm.orders, function (order, index) {
    return _vm._ssrNode("<div class=\"order-card\" data-v-2beedc61>", "</div>", [_vm._ssrNode("<div class=\"order-card__header\" data-v-2beedc61><p data-v-2beedc61><strong data-v-2beedc61>Order ID:</strong>" + _vm._ssrEscape(" " + _vm._s(order._id)) + "</p> <p data-v-2beedc61><strong data-v-2beedc61>Total:</strong>" + _vm._ssrEscape(" ₦" + _vm._s(order.checkout_id.total.toLocaleString())) + "</p> <p data-v-2beedc61><strong data-v-2beedc61>Date:</strong>" + _vm._ssrEscape(" " + _vm._s(_vm.formatDate(order.checkout_id.delivery_date))) + "</p> <button class=\"order-card__togglecart transparent-button\" data-v-2beedc61>" + _vm._ssrEscape("\n                            " + _vm._s(_vm.expanded[index] ? 'Hide Cart' : 'View Cart') + "\n                        ") + "</button></div> "), _c('transition', {
      attrs: {
        "name": "fade"
      }
...
// CONCATENATED MODULE: ./pages/orders.vue?vue&type=template&id=2beedc61&scoped=true
