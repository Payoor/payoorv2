...
var add = __webpack_require__(6).default
module.exports.__inject__ = function (context) {
  add("8649919a", content, true, context)
};
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/ChatHeader.vue?vue&type=template&id=4b16276a&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "chat-header"
  }, [_vm._ssrNode("<div class=\"chat-header__left\" data-v-4b16276a>" + (_vm.name ? "<div class=\"chat-header__name\" data-v-4b16276a><span class=\"svg\" data-v-4b16276a><svg data-v-4b16276a><use xlink:href=\"/svg/symbol-defs.svg#icon-arrow_back\" data-v-4b16276a></use></svg></span> <span class=\"label\" data-v-4b16276a>" + _vm._ssrEscape(_vm._s(_vm.name)) + "</span></div>" : "<!---->") + " " + (_vm.logovisible ? "<figure" + _vm._ssrClass("chat-header__left--logo", {
    green: _vm.green
  }) + " data-v-4b16276a><img src=\"/imgs/logo.png\" data-v-4b16276a></figure>" : "<!---->") + "</div> "), _vm._ssrNode("<div class=\"chat-header__right\" data-v-4b16276a>", "</div>", [_vm._ssrNode("<div class=\"chat-header__right--cart\" data-v-4b16276a>", "</div>", [_c('CartButton', {
    attrs: {
      "showicon": true
    }
    ...
    unauth: !_vm.jwtToken,
    green: _vm.green
  }) + " data-v-4b16276a><span data-v-4b16276a></span><span data-v-4b16276a></span><span data-v-4b16276a></span></div>")], 2), _vm._ssrNode(" "), _vm.menuopen ? _vm._ssrNode("<div" + _vm._ssrClass("chat-header__menu", {
    auth: _vm.jwtToken
  }) + " data-v-4b16276a>", "</div>", [_vm._ssrNode("<div class=\"chat-header__menubody slide-in-left\" data-v-4b16276a>", "</div>", [_vm._ssrNode("<div class=\"chat-header__menuitems\" data-v-4b16276a>", "</div>", [_vm._ssrNode("<figure class=\"chat-header__left--logo bottom-1rem\" data-v-4b16276a>", "</figure>", [_c('img', {
    directives: [{
      name: "lazy",
      rawName: "v-lazy",
      value: '/imgs/logo.png',
  ...
  }, [])]), _vm._ssrNode(" <div class=\"chat-header__menuitem\" data-v-4b16276a><span class=\"svg\" data-v-4b16276a></span> <span class=\"label\" data-v-4b16276a>About us</span></div> " + (!_vm.jwtToken ? "<div class=\"chat-header__menuitem\" data-v-4b16276a><span class=\"svg\" data-v-4b16276a></span> <span class=\"label\" data-v-4b16276a>Sign In/Sign Up</span></div>" : "<!---->") + " " + (_vm.jwtToken ? "<div class=\"chat-header__menuitem\" data-v-4b16276a><span class=\"svg\" data-v-4b16276a></span> <span class=\"label\" data-v-4b16276a>Orders</span></div>" : "<!---->"))], 2), _vm._ssrNode(" <div class=\"chat-header__menuitems\" data-v-4b16276a><div class=\"chat-header__menuitem\" data-v-4b16276a><span class=\"svg\" data-v-4b16276a></span></div> " + (_vm.jwtToken ? "<div class=\"chat-header__menuitem\" data-v-4b16276a><span class=\"svg\" data-v-4b16276a></span> <span class=\"label\" data-v-4b16276a>Signout</span></div>" : "<!---->") + "</div>")], 2)]) : _vm._e()], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./components/ChatHeader.vue?vue&type=template&id=4b16276a&scoped=true
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ChatHeader_vue_vue_type_style_index_0_id_4b16276a_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(47);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ChatHeader_vue_vue_type_style_index_0_id_4b16276a_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ChatHeader_vue_vue_type_style_index_0_id_4b16276a_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ChatHeader_vue_vue_type_style_index_0_id_4b16276a_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ChatHeader_vue_vue_type_style_index_0_id_4b16276a_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, "*[data-v-4b16276a],[data-v-4b16276a]:after,[data-v-4b16276a]:before{box-sizing:inherit;margin:0;padding:0}html[data-v-4b16276a]{background:#249b48;font-size:62.5%}@media only screen and (max-width:75em){html[data-v-4b16276a]{font-size:56.25%}}@media only screen and (max-width:56.25em){html[data-v-4b16276a]{font-size:55%}}@media only screen and (max-width:37.5em){html[data-v-4b16276a]{font-size:50%}}@media only screen and (min-width:112.5em){html[data-v-4b16276a]{font-size:65%}}body[data-v-4b16276a]{background:#249b48;box-sizing:border-box;display:none;font-family:\"Poppins\",sans-serif}@media only screen and (max-width:56.25em){body[data-v-4b16276a]{padding:0}}[data-v-4b16276a]::-moz-selection{background-color:#249b48;color:#fff}[data-v-4b16276a]::selection{background-color:#249b48;color:#fff}[data-v-4b16276a]::-webkit-scrollbar{height:8px;width:8px}[data-v-4b16276a]::-webkit-scrollbar-track{background:transparent}[data-v-4b16276a]::-webkit-scrollbar-thumb{background-color:#249b48;border:none;border-radius:10px}[data-v-4b16276a]::-webkit-scrollbar-thumb:hover{background-color:#1a7235}*[data-v-4b16276a]{scrollbar-color:#249b48 transparent;scrollbar-width:thin}@keyframes slideFadeInUp-4b16276a{0%{opacity:0;transform:translateY(20px)}to{opacity:1;transform:translateY(0)}}@keyframes slide-in-left-4b16276a{0%{opacity:0;transform:translateX(-100%)}to{opacity:1;transform:translateX(0)}}@keyframes float-4b16276a{0%{transform:translateY(0)}50%{transform:translateY(-10px)}to{transform:translateY(0)}}@keyframes spin-4b16276a{to{transform:rotate(1turn)}}.slide-in-left[data-v-4b16276a]{animation:slide-in-left-4b16276a .5s ease-out forwards}.button-primary[data-v-4b16276a]{background:#249b48;border:none;border-radius:1rem;color:#fff;font-weight:500;outline:none;padding:1rem}.transparent-button[data-v-4b16276a]{background:transparent;border:1px solid #249b48;color:#249b48}.disabled-btn[data-v-4b16276a]{opacity:.4}.floating-element[data-v-4b16276a]{animation:float-4b16276a 3s ease-in-out infinite;animation-delay:0s;transition:transform .2s ease}.no-scroll[data-v-4b16276a]{height:100vh!important;overflow:hidden!important}.spinner[data-v-4b16276a]{animation:spin-4b16276a 1s linear infinite;border:4px solid rgba(36,155,72,.3);border-radius:50%;border-top-color:#249b48;height:3rem;width:3rem}.spinner.path[data-v-4b16276a]{stroke:#249b48;stroke-linecap:round}.blur-effect[data-v-4b16276a]{filter:blur(3px)}.landing[data-v-4b16276a]{overflow-x:hidden}.landing__top[data-v-4b16276a]{background:#b6edf2;display:grid;grid-template-columns:repeat(2,1fr);height:100vh;left:0;position:fixed;top:0;width:100%}@media only screen and (max-width:56.25em){.landing__top[data-v-4b16276a]{display:flex}}.landing__topleft[data-v-4b16276a]{display:flex;justify-content:center}@media only screen and (max-width:56.25em){.landing__topleft[data-v-4b16276a]{display:block;width:100%}}.landing__topleft--auth[data-v-4b16276a]{padding:0 10rem;width:100rem}@media only screen and (max-width:56.25em){.landing__topleft--auth[data-v-4b16276a]{padding:0;width:auto}}.landing__topright[data-v-4b16276a],.landing__topright--img[data-v-4b16276a]{align-items:center;display:flex;justify-content:center}.landing__topright--img[data-v-4b16276a]{transform:scale(1.1);width:100rem}.landing__topright--img img[data-v-4b16276a]{height:100%;-o-object-fit:contain;object-fit:contain;width:100%}@media only screen and (max-width:56.25em){.landing__topright[data-v-4b16276a]{display:none}}.landing__content[data-v-4b16276a]{background:#249b48;margin-top:90rem;position:relative}.landing__seemore[data-v-4b16276a]{bottom:10rem;display:flex;justify-content:center;left:0;position:absolute;width:100%}.landing__seemore button[data-v-4b16276a]{background:transparent;border:1px solid #fff;border-radius:3rem;color:#fff;cursor:pointer;font-size:1.4rem;font-weight:600;padding:1rem 4rem}.landing__cloud[data-v-4b16276a]{bottom:0;height:34rem;position:absolute;transform:scale(1.1);width:100vw;z-index:3}.landing__cloud img[data-v-4b16276a]{height:100%;-o-object-fit:cover;object-fit:cover;width:100%}.chat-header[data-v-4b16276a]{align-items:center;display:flex;justify-content:space-between;padding:3rem}@media only screen and (max-width:37.5em){.chat-header[data-v-4b16276a]{padding:2rem}}.chat-header__name[data-v-4b16276a],.chat-header__name span.svg[data-v-4b16276a]{align-items:center;display:flex}.chat-header__name span.svg[data-v-4b16276a]{margin-right:.5rem}.chat-header__name span.svg svg[data-v-4b16276a]{height:2rem;width:2rem;fill:#249b48;color:#249b48}.chat-header__name span.label[data-v-4b16276a]{align-items:center;color:#249b48;display:flex;font-size:2rem;font-weight:600}@media only screen and (max-width:56.25em){.chat-header__right--cart[data-v-4b16276a]{display:none}}.chat-header__left--logo[data-v-4b16276a]{height:3rem}.chat-header__left--logo.bottom-1rem[data-v-4b16276a]{margin-bottom:5rem}.chat-header__left--logo img[data-v-4b16276a]{height:100%;-o-object-fit:cover;object-fit:cover;width:auto}.chat-header__left--logo.green[data-v-4b16276a]{height:3.5rem}.chat-header__burger[data-v-4b16276a]{display:flex;flex-direction:column;height:2.5rem;justify-content:space-between}.chat-header__burger span[data-v-4b16276a]{background:#249b48;border-radius:1rem;display:inline-block;flex-shrink:0;height:.35rem;margin:.2rem 0;width:3rem}.chat-header__burger span[data-v-4b16276a]:nth-child(2){height:.35rem;width:2rem}.chat-header__burger.unauth span[data-v-4b16276a]{background:#fff}.chat-header__burger.green span[data-v-4b16276a]{background:#249b48}.chat-header__menu[data-v-4b16276a]{background:rgba(0,0,0,.6);height:100vh;left:0;overflow:hidden;overflow-y:scroll;position:fixed;top:0;width:100vw}.chat-header__menu.auth[data-v-4b16276a]{background:transparent;box-shadow:20px 0 30px -10px rgba(36,155,72,.1);width:auto}@media only screen and (max-width:56.25em){.chat-header__menu[data-v-4b16276a],.chat-header__menu.auth[data-v-4b16276a]{background:rgba(0,0,0,.6);box-shadow:none;overflow:hidden;overflow-y:scroll;width:100vw}}.chat-header__menuitem[data-v-4b16276a]{cursor:pointer;font-size:1.4rem;font-weight:500;margin-bottom:3rem;-webkit-text-decoration:none;text-decoration:none}@media only screen and (max-width:56.25em){.chat-header__menuitem[data-v-4b16276a]{font-size:1.8rem}}.chat-header__menuitem span[data-v-4b16276a]{-webkit-text-decoration:none;text-decoration:none}.chat-header__menubody[data-v-4b16276a]{background:#fff;color:#000;display:flex;flex-direction:column;height:100vh;justify-content:space-between;padding:2rem 2rem 14rem;width:35rem}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
