...
module.exports.__inject__ = function (context) {
  add("79bb1491", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_authp_vue_vue_type_style_index_0_id_0564f44f_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(120);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_authp_vue_vue_type_style_index_0_id_0564f44f_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_authp_vue_vue_type_style_index_0_id_0564f44f_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_authp_vue_vue_type_style_index_0_id_0564f44f_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_authp_vue_vue_type_style_index_0_id_0564f44f_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, "*[data-v-0564f44f],[data-v-0564f44f]:after,[data-v-0564f44f]:before{box-sizing:inherit;margin:0;padding:0}html[data-v-0564f44f]{background:#249b48;font-size:62.5%}@media only screen and (max-width:75em){html[data-v-0564f44f]{font-size:56.25%}}@media only screen and (max-width:56.25em){html[data-v-0564f44f]{font-size:55%}}@media only screen and (max-width:37.5em){html[data-v-0564f44f]{font-size:50%}}@media only screen and (min-width:112.5em){html[data-v-0564f44f]{font-size:65%}}body[data-v-0564f44f]{background:#249b48;box-sizing:border-box;display:none;font-family:\"Poppins\",sans-serif}@media only screen and (max-width:56.25em){body[data-v-0564f44f]{padding:0}}[data-v-0564f44f]::-moz-selection{background-color:#249b48;color:#fff}[data-v-0564f44f]::selection{background-color:#249b48;color:#fff}[data-v-0564f44f]::-webkit-scrollbar{height:8px;width:8px}[data-v-0564f44f]::-webkit-scrollbar-track{background:transparent}[data-v-0564f44f]::-webkit-scrollbar-thumb{background-color:#249b48;border:none;border-radius:10px}[data-v-0564f44f]::-webkit-scrollbar-thumb:hover{background-color:#1a7235}*[data-v-0564f44f]{scrollbar-color:#249b48 transparent;scrollbar-width:thin}@keyframes slideFadeInUp-0564f44f{0%{opacity:0;transform:translateY(20px)}to{opacity:1;transform:translateY(0)}}@keyframes slide-in-left-0564f44f{0%{opacity:0;transform:translateX(-100%)}to{opacity:1;transform:translateX(0)}}@keyframes float-0564f44f{0%{transform:translateY(0)}50%{transform:translateY(-10px)}to{transform:translateY(0)}}@keyframes spin-0564f44f{to{transform:rotate(1turn)}}.slide-in-left[data-v-0564f44f]{animation:slide-in-left-0564f44f .5s ease-out forwards}.button-primary[data-v-0564f44f]{background:#249b48;border:none;border-radius:1rem;color:#fff;font-weight:500;outline:none;padding:1rem}.transparent-button[data-v-0564f44f]{background:transparent;border:1px solid #249b48;color:#249b48}.disabled-btn[data-v-0564f44f]{opacity:.4}.floating-element[data-v-0564f44f]{animation:float-0564f44f 3s ease-in-out infinite;animation-delay:0s;transition:transform .2s ease}.no-scroll[data-v-0564f44f]{height:100vh!important;overflow:hidden!important}.spinner[data-v-0564f44f]{animation:spin-0564f44f 1s linear infinite;border:4px solid rgba(36,155,72,.3);border-radius:50%;border-top-color:#249b48;height:3rem;width:3rem}.spinner.path[data-v-0564f44f]{stroke:#249b48;stroke-linecap:round}.blur-effect[data-v-0564f44f]{filter:blur(3px)}.error-message[data-v-0564f44f]{animation:slideFadeInUp-0564f44f .5s ease-out forwards;background:#fff;border-radius:1rem;bottom:15rem;color:red;font-size:1.48rem;font-weight:500;left:0;line-height:2.1rem;margin:2rem 16px;padding:2rem;position:fixed;right:0;z-index:30}.error-message-timeout-bar[data-v-0564f44f]{background-color:#249b48;bottom:0;height:4px;left:0;position:absolute;transition:width 4s linear;width:100%}.landing[data-v-0564f44f]{overflow-x:hidden}.landing__top[data-v-0564f44f]{background:#b6edf2;display:grid;grid-template-columns:repeat(2,1fr);height:100vh;left:0;position:fixed;top:0;width:100%}@media only screen and (max-width:56.25em){.landing__top[data-v-0564f44f]{display:flex}}.landing__topleft[data-v-0564f44f]{display:flex;justify-content:center}@media only screen and (max-width:56.25em){.landing__topleft[data-v-0564f44f]{display:block;width:100%}}.landing__topleft--auth[data-v-0564f44f]{padding:0 10rem;width:100rem}@media only screen and (max-width:56.25em){.landing__topleft--auth[data-v-0564f44f]{padding:0;width:auto}}.landing__topright[data-v-0564f44f],.landing__topright--img[data-v-0564f44f]{align-items:center;display:flex;justify-content:center}.landing__topright--img[data-v-0564f44f]{transform:scale(1.1);width:100rem}.landing__topright--img img[data-v-0564f44f]{height:100%;-o-object-fit:contain;object-fit:contain;width:100%}@media only screen and (max-width:56.25em){.landing__topright[data-v-0564f44f]{display:none}}.landing__content[data-v-0564f44f]{background:#249b48;margin-top:90rem;position:relative}.landing__seemore[data-v-0564f44f]{bottom:10rem;display:flex;justify-content:center;left:0;position:absolute;width:100%}.landing__seemore button[data-v-0564f44f]{background:transparent;border:1px solid #fff;border-radius:3rem;color:#fff;cursor:pointer;font-size:1.4rem;font-weight:600;padding:1rem 4rem}.landing__cloud[data-v-0564f44f]{bottom:0;height:34rem;position:absolute;transform:scale(1.1);width:100vw;z-index:3}.landing__cloud img[data-v-0564f44f]{height:100%;-o-object-fit:cover;object-fit:cover;width:100%}.auth-page[data-v-0564f44f]{background:#b6edf2;min-height:100vh;overflow:hidden;position:relative}.auth-page__header[data-v-0564f44f]{left:0;position:fixed;top:0;width:100vw;z-index:6}.auth-page__header.auth[data-v-0564f44f],.auth-page__header.unauth[data-v-0564f44f]{background:transparent}@media only screen and (max-width:56.25em){.auth-page__header.auth[data-v-0564f44f]{background:#fff}}.auth-page__content[data-v-0564f44f]{overflow:hidden;position:relative}.auth-page__formarea[data-v-0564f44f]{align-items:center;display:flex;height:100vh;left:0;padding:3rem;position:fixed;top:0;width:100vw}.auth-page__formquest[data-v-0564f44f]{transform:translateY(-9rem)}.auth-page__h1[data-v-0564f44f]{animation:fadeInUp-0564f44f 1s ease-out forwards;font-size:2.8rem;font-weight:300}.auth-page__h1--email[data-v-0564f44f]{color:#249b48;font-size:2.5rem;font-weight:500}@keyframes fadeInUp-0564f44f{0%{opacity:0;transform:translateY(20px)}to{opacity:1;transform:translateY(0)}}.auth-page__bottom[data-v-0564f44f]{background:#b6edf2;bottom:0;display:flex;justify-content:center;left:0;padding:3rem 3rem .4rem;position:fixed;width:100vw;z-index:5}.auth-page__bottom--cart[data-v-0564f44f]{display:none}@media only screen and (max-width:56.25em){.auth-page__bottom--cart[data-v-0564f44f]{display:block}.auth-page__bottom[data-v-0564f44f]{display:block;padding:0}}.auth-page__otp[data-v-0564f44f]{margin-top:3rem}.auth-page__otp--header[data-v-0564f44f]{color:#249b48;font-size:1.6rem;font-weight:600;margin-bottom:2rem;text-align:center}.auth-page__otp--resendbtn[data-v-0564f44f]{color:#249b48;cursor:pointer;font-size:1.6rem;font-weight:500;margin-top:1rem;text-align:center}.auth-page__otp--resendotp[data-v-0564f44f]{-webkit-text-decoration:underline;text-decoration:underline}.auth-page__otp--counter[data-v-0564f44f]{color:#000;font-size:1.1rem}.auth-page__loading[data-v-0564f44f]{align-items:center;display:flex;height:100vh;justify-content:center;position:fixed;top:0;width:100vw}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/authp.vue?vue&type=template&id=0564f44f&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_vm._ssrNode("<div class=\"auth-page\" data-v-0564f44f>", "</div>", [_vm._ssrNode("<div class=\"auth-page__content\" data-v-0564f44f>", "</div>", [_vm._ssrNode("<div class=\"auth-page__header unauth\" data-v-0564f44f>", "</div>", [_c('ChatHeader', {
    attrs: {
      "logovisible": true,
      "green": true
    }
  })], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"auth-page__formarea\" data-v-0564f44f>", "</div>", [_vm._ssrNode("<div" + _vm._ssrClass("auth-page__formquest", {
    'blur-effect': _vm.isLoading
  }) + " data-v-0564f44f>", "</div>", [_vm._ssrNode((!_vm.currentUser.email ? "<h1 class=\"auth-page__h1\" data-v-0564f44f><span data-v-0564f44f>What's your email Address</span> <span data-v-0564f44f>We'll send an otp to</span> <span data-v-0564f44f>authenticate it.</span></h1>" : "<!---->") + " " + (_vm.currentUser.email && _vm.currentUser.otpMode ? "<h1 class=\"auth-page__h1\" data-v-0564f44f><span data-v-0564f44f>We just sent <span class=\"auth-page__h1--email\" data-v-0564f44f>" + _vm._ssrEscape(_vm._s(_vm.$route.query.email) + " ") + "</span>an\n                            otp. </span> <span data-v-0564f44f>kindly provide it to confirm email</span> <span data-v-0564f44f>(Please check spam if it doesn’t</span> <span data-v-0564f44f>appear in your inbox).</span></h1>" : "<!---->") + " " + (_vm.currentUser.email && !_vm.currentUser.otpMode && !_vm.currentUser.phoneNumber ? "<h1 class=\"auth-page__h1\" data-v-0564f44f><span data-v-0564f44f>Kindly provide a valid phone</span> <span data-v-0564f44f>number</span></h1>" : "<!---->") + " " + (_vm.currentUser.email && !_vm.currentUser.otpMode && _vm.currentUser.phoneNumber && !_vm.currentUser.name ? "<h1 class=\"auth-page__h1\" data-v-0564f44f><span data-v-0564f44f>Lastly, let us know your Name.</span></h1>" : "<!---->") + " "), _vm.currentUser.email && _vm.currentUser.otpMode ? _vm._ssrNode("<div class=\"auth-page__otp\" data-v-0564f44f>", "</div>", [_c('OtpInput', {
    attrs: {
      "disabled": _vm.isLoading,
      "setIsLoading": _vm.setIsLoading,
      "otpLength": 6
    }
  })], 1) : _vm._e(), _vm._ssrNode(" " + (_vm.currentUser.email && _vm.currentUser.otpMode ? "<div data-v-0564f44f><p class=\"auth-page__otp--resendbtn\" data-v-0564f44f>" + (_vm.allowResendOtp ? "<span class=\"auth-page__otp--resendotp\" data-v-0564f44f>Resend\n                                OTP</span>" : "<!---->") + " " + (!_vm.allowResendOtp ? "<span class=\"auth-page__otp--resendotp disabled-btn\" data-v-0564f44f>Resend\n                                OTP</span>" : "<!---->") + " <span class=\"auth-page__otp--counter\" data-v-0564f44f>" + _vm._ssrEscape(_vm._s(_vm.allowResendOtpCounter)) + "</span></p></div>" : "<!---->"))], 2), _vm._ssrNode(" "), _vm.isLoading ? _vm._ssrNode("<div class=\"auth-page__loading\" data-v-0564f44f>", "</div>", [_c('LoadingAnimation')], 1) : _vm._e()], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"auth-page__bottom\" data-v-0564f44f>", "</div>", [_vm._ssrNode("<div data-v-0564f44f>", "</div>", [_vm._ssrNode("<div class=\"blur-effect\" data-v-0564f44f>", "</div>", [_c('ChatCategories', {
    attrs: {
      "jwt": _vm.jwt,
      "prevent_click": true
    }
  ...
  }) + " data-v-0564f44f>", "</div>", [_c('ChatInput', {
    attrs: {
      "jwt": _vm.jwt,
      "getOtp": _vm.getOtp
    }
...
// CONCATENATED MODULE: ./pages/authp.vue?vue&type=template&id=0564f44f&scoped=true
