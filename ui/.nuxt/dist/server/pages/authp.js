...
module.exports.__inject__ = function (context) {
  add("6ecb5180", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_authp_vue_vue_type_style_index_0_id_af86aa4e_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(122);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_authp_vue_vue_type_style_index_0_id_af86aa4e_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_authp_vue_vue_type_style_index_0_id_af86aa4e_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_authp_vue_vue_type_style_index_0_id_af86aa4e_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_authp_vue_vue_type_style_index_0_id_af86aa4e_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, "*[data-v-af86aa4e],[data-v-af86aa4e]:after,[data-v-af86aa4e]:before{box-sizing:inherit;margin:0;padding:0}html[data-v-af86aa4e]{background:#249b48;font-size:62.5%}@media only screen and (max-width:75em){html[data-v-af86aa4e]{font-size:56.25%}}@media only screen and (max-width:56.25em){html[data-v-af86aa4e]{font-size:55%}}@media only screen and (max-width:37.5em){html[data-v-af86aa4e]{font-size:50%}}@media only screen and (min-width:112.5em){html[data-v-af86aa4e]{font-size:65%}}body[data-v-af86aa4e]{background:#249b48;box-sizing:border-box;display:none;font-family:\"Poppins\",sans-serif}@media only screen and (max-width:56.25em){body[data-v-af86aa4e]{padding:0}}[data-v-af86aa4e]::-moz-selection{background-color:#249b48;color:#fff}[data-v-af86aa4e]::selection{background-color:#249b48;color:#fff}[data-v-af86aa4e]::-webkit-scrollbar{height:8px;width:8px}[data-v-af86aa4e]::-webkit-scrollbar-track{background:transparent}[data-v-af86aa4e]::-webkit-scrollbar-thumb{background-color:#249b48;border:none;border-radius:10px}[data-v-af86aa4e]::-webkit-scrollbar-thumb:hover{background-color:#1a7235}*[data-v-af86aa4e]{scrollbar-color:#249b48 transparent;scrollbar-width:thin}@keyframes slideFadeInUp-af86aa4e{0%{opacity:0;transform:translateY(20px)}to{opacity:1;transform:translateY(0)}}@keyframes slide-in-left-af86aa4e{0%{opacity:0;transform:translateX(-100%)}to{opacity:1;transform:translateX(0)}}@keyframes float-af86aa4e{0%{transform:translateY(0)}50%{transform:translateY(-10px)}to{transform:translateY(0)}}@keyframes spin-af86aa4e{to{transform:rotate(1turn)}}.slide-in-left[data-v-af86aa4e]{animation:slide-in-left-af86aa4e .5s ease-out forwards}.button-primary[data-v-af86aa4e]{background:#249b48;border:none;border-radius:1rem;color:#fff;font-weight:500;outline:none;padding:1rem}.transparent-button[data-v-af86aa4e]{background:transparent;border:1px solid #249b48;color:#249b48}.disabled-btn[data-v-af86aa4e]{opacity:.4}.floating-element[data-v-af86aa4e]{animation:float-af86aa4e 3s ease-in-out infinite;animation-delay:0s;transition:transform .2s ease}.no-scroll[data-v-af86aa4e]{height:100vh!important;overflow:hidden!important}.spinner[data-v-af86aa4e]{animation:spin-af86aa4e 1s linear infinite;border:4px solid rgba(36,155,72,.3);border-radius:50%;border-top-color:#249b48;height:3rem;width:3rem}.spinner.path[data-v-af86aa4e]{stroke:#249b48;stroke-linecap:round}.blur-effect[data-v-af86aa4e]{filter:blur(3px)}.landing[data-v-af86aa4e]{overflow-x:hidden}.landing__top[data-v-af86aa4e]{background:#b6edf2;display:grid;grid-template-columns:repeat(2,1fr);height:100vh;left:0;position:fixed;top:0;width:100%}@media only screen and (max-width:56.25em){.landing__top[data-v-af86aa4e]{display:flex}}.landing__topleft[data-v-af86aa4e]{display:flex;justify-content:center}@media only screen and (max-width:56.25em){.landing__topleft[data-v-af86aa4e]{display:block;width:100%}}.landing__topleft--auth[data-v-af86aa4e]{padding:0 10rem;width:100rem}@media only screen and (max-width:56.25em){.landing__topleft--auth[data-v-af86aa4e]{padding:0;width:auto}}.landing__topright[data-v-af86aa4e],.landing__topright--img[data-v-af86aa4e]{align-items:center;display:flex;justify-content:center}.landing__topright--img[data-v-af86aa4e]{transform:scale(1.1);width:100rem}.landing__topright--img img[data-v-af86aa4e]{height:100%;-o-object-fit:contain;object-fit:contain;width:100%}@media only screen and (max-width:56.25em){.landing__topright[data-v-af86aa4e]{display:none}}.landing__content[data-v-af86aa4e]{background:#249b48;margin-top:90rem;position:relative}.landing__seemore[data-v-af86aa4e]{bottom:10rem;display:flex;justify-content:center;left:0;position:absolute;width:100%}.landing__seemore button[data-v-af86aa4e]{background:transparent;border:1px solid #fff;border-radius:3rem;color:#fff;cursor:pointer;font-size:1.4rem;font-weight:600;padding:1rem 4rem}.landing__cloud[data-v-af86aa4e]{bottom:0;height:34rem;position:absolute;transform:scale(1.1);width:100vw;z-index:3}.landing__cloud img[data-v-af86aa4e]{height:100%;-o-object-fit:cover;object-fit:cover;width:100%}.auth-page[data-v-af86aa4e]{background:#b6edf2;min-height:100vh;overflow:hidden;position:relative}.auth-page__header[data-v-af86aa4e]{left:0;position:fixed;top:0;width:100vw;z-index:6}.auth-page__header.auth[data-v-af86aa4e],.auth-page__header.unauth[data-v-af86aa4e]{background:transparent}@media only screen and (max-width:56.25em){.auth-page__header.auth[data-v-af86aa4e]{background:#fff}}.auth-page__content[data-v-af86aa4e]{overflow:hidden;position:relative}.auth-page__formarea[data-v-af86aa4e]{align-items:center;display:flex;height:100vh;left:0;padding:3rem;position:fixed;top:0;width:100vw}.auth-page__formquest[data-v-af86aa4e]{transform:translateY(-9rem)}.auth-page__h1[data-v-af86aa4e]{animation:fadeInUp-af86aa4e 1s ease-out forwards;font-size:2.8rem;font-weight:300}@keyframes fadeInUp-af86aa4e{0%{opacity:0;transform:translateY(20px)}to{opacity:1;transform:translateY(0)}}.auth-page__bottom[data-v-af86aa4e]{background:#b6edf2;bottom:0;display:flex;justify-content:center;left:0;padding:3rem 3rem .4rem;position:fixed;width:100vw;z-index:5}.auth-page__bottom--cart[data-v-af86aa4e]{display:none}@media only screen and (max-width:56.25em){.auth-page__bottom--cart[data-v-af86aa4e]{display:block}.auth-page__bottom[data-v-af86aa4e]{display:block;padding:0}}.auth-page__otp[data-v-af86aa4e]{margin-top:3rem}.auth-page__otp--header[data-v-af86aa4e]{color:#249b48;font-size:1.6rem;font-weight:600;margin-bottom:2rem;text-align:center}.auth-page__otp--resendbtn[data-v-af86aa4e]{color:#249b48;cursor:pointer;font-size:1.6rem;font-weight:500;margin-top:1rem;text-align:center}.auth-page__otp--resendotp[data-v-af86aa4e]{-webkit-text-decoration:underline;text-decoration:underline}.auth-page__otp--counter[data-v-af86aa4e]{color:#000;font-size:1.1rem}.auth-page__loading[data-v-af86aa4e]{align-items:center;display:flex;height:100vh;justify-content:center;position:fixed;top:0;width:100vw}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/authp.vue?vue&type=template&id=af86aa4e&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_vm._ssrNode("<div class=\"auth-page\" data-v-af86aa4e>", "</div>", [_vm._ssrNode("<div class=\"auth-page__content\" data-v-af86aa4e>", "</div>", [_vm._ssrNode("<div class=\"auth-page__header unauth\" data-v-af86aa4e>", "</div>", [_c('ChatHeader', {
    attrs: {
      "logovisible": true,
      "green": true
    }
  })], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"auth-page__formarea\" data-v-af86aa4e>", "</div>", [_vm._ssrNode("<div" + _vm._ssrClass("auth-page__formquest", {
    'blur-effect': _vm.isLoading
  }) + " data-v-af86aa4e>", "</div>", [_vm._ssrNode((!_vm.currentUser.email ? "<h1 class=\"auth-page__h1\" data-v-af86aa4e><span data-v-af86aa4e>What's your email Address</span> <span data-v-af86aa4e>We'll send an otp to</span> <span data-v-af86aa4e>authenticate it.</span></h1>" : "<!---->") + " " + (_vm.currentUser.email && _vm.currentUser.otpMode ? "<h1 class=\"auth-page__h1\" data-v-af86aa4e><span data-v-af86aa4e>We just sent you an otp. </span> <span data-v-af86aa4e>kindly provide it to confirm email</span> <span data-v-af86aa4e>(Please check spam if it doesn’t</span> <span data-v-af86aa4e>appear in your inbox).</span></h1>" : "<!---->") + " " + (_vm.currentUser.email && !_vm.currentUser.otpMode && !_vm.currentUser.phoneNumber ? "<h1 class=\"auth-page__h1\" data-v-af86aa4e><span data-v-af86aa4e>Kindly provide a valid phone</span> <span data-v-af86aa4e>number</span></h1>" : "<!---->") + " " + (_vm.currentUser.email && !_vm.currentUser.otpMode && _vm.currentUser.phoneNumber && !_vm.currentUser.name ? "<h1 class=\"auth-page__h1\" data-v-af86aa4e><span data-v-af86aa4e>Lastly, let us know your Name.</span></h1>" : "<!---->") + " "), _vm.currentUser.email && _vm.currentUser.otpMode ? _vm._ssrNode("<div class=\"auth-page__otp\" data-v-af86aa4e>", "</div>", [_c('OtpInput', {
    attrs: {
  ...
  })], 1) : _vm._e(), _vm._ssrNode(" " + (_vm.currentUser.email && _vm.currentUser.otpMode ? "<div data-v-af86aa4e><p class=\"auth-page__otp--resendbtn\" data-v-af86aa4e>" + (_vm.allowResendOtp ? "<span class=\"auth-page__otp--resendotp\" data-v-af86aa4e>Resend\n                                OTP</span>" : "<!---->") + " " + (!_vm.allowResendOtp ? "<span class=\"auth-page__otp--resendotp disabled-btn\" data-v-af86aa4e>Resend\n                                OTP</span>" : "<!---->") + " <span class=\"auth-page__otp--counter\" data-v-af86aa4e>" + _vm._ssrEscape(_vm._s(_vm.allowResendOtpCounter)) + "</span></p></div>" : "<!---->"))], 2), _vm._ssrNode(" "), _vm.isLoading ? _vm._ssrNode("<div class=\"auth-page__loading\" data-v-af86aa4e>", "</div>", [_c('LoadingAnimation')], 1) : _vm._e()], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"auth-page__bottom\" data-v-af86aa4e>", "</div>", [_vm._ssrNode("<div data-v-af86aa4e>", "</div>", [_vm._ssrNode("<div class=\"blur-effect\" data-v-af86aa4e>", "</div>", [_c('ChatCategories', {
    attrs: {
      "jwt": _vm.jwt,
  ...
  }) + " data-v-af86aa4e>", "</div>", [_c('ChatInput', {
    attrs: {
      "jwt": _vm.jwt,
      "setLoading": _vm.setLoading,
      "getOtp": _vm.getOtp
...
// CONCATENATED MODULE: ./pages/authp.vue?vue&type=template&id=af86aa4e&scoped=true
...
installComponents(component, {ChatHeader: __webpack_require__(53).default,OtpInput: __webpack_require__(109).default,LoadingAnimation: __webpack_require__(52).default,ChatCategories: __webpack_require__(94).default,ChatInput: __webpack_require__(95).default})
...
var add = __webpack_require__(6).default
module.exports.__inject__ = function (context) {
  add("70accbc4", content, true, context)
};
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/ChatHeader.vue?vue&type=template&id=ba1d9aec&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "chat-header"
  }, [_vm._ssrNode("<div class=\"chat-header__left\" data-v-ba1d9aec>" + (_vm.name ? "<div class=\"chat-header__name\" data-v-ba1d9aec><span class=\"svg\" data-v-ba1d9aec><svg data-v-ba1d9aec><use xlink:href=\"/svg/symbol-defs.svg#icon-arrow_back\" data-v-ba1d9aec></use></svg></span> <span class=\"label\" data-v-ba1d9aec>" + _vm._ssrEscape(_vm._s(_vm.name)) + "</span></div>" : "<!---->") + " " + (_vm.logovisible ? "<figure" + _vm._ssrClass("chat-header__left--logo", {
    green: _vm.green
  }) + " data-v-ba1d9aec><img src=\"/imgs/logo.png\" data-v-ba1d9aec></figure>" : "<!---->") + "</div> "), _vm._ssrNode("<div class=\"chat-header__right\" data-v-ba1d9aec>", "</div>", [_vm._ssrNode("<div class=\"chat-header__right--cart\" data-v-ba1d9aec>", "</div>", [_c('CartButton', {
    attrs: {
      "showicon": true
    }
    ...
    unauth: !_vm.jwtToken,
    green: _vm.green
  }) + " data-v-ba1d9aec><span data-v-ba1d9aec></span><span data-v-ba1d9aec></span><span data-v-ba1d9aec></span></div>")], 2), _vm._ssrNode(" "), _vm.menuopen ? _vm._ssrNode("<div" + _vm._ssrClass("chat-header__menu", {
    auth: _vm.jwtToken
  }) + " data-v-ba1d9aec>", "</div>", [_vm._ssrNode("<div class=\"chat-header__menubody slide-in-left\" data-v-ba1d9aec>", "</div>", [_vm._ssrNode("<div class=\"chat-header__menuitems\" data-v-ba1d9aec>", "</div>", [_vm._ssrNode("<figure class=\"chat-header__left--logo bottom-1rem\" data-v-ba1d9aec>", "</figure>", [_c('img', {
    directives: [{
      name: "lazy",
      rawName: "v-lazy",
      value: '/imgs/logo.png',
  ...
  }, [])]), _vm._ssrNode(" <div class=\"chat-header__menuitem\" data-v-ba1d9aec><span class=\"svg\" data-v-ba1d9aec></span> <span class=\"label\" data-v-ba1d9aec>About us</span></div> " + (!_vm.jwtToken ? "<div class=\"chat-header__menuitem\" data-v-ba1d9aec><span class=\"svg\" data-v-ba1d9aec></span> <span class=\"label\" data-v-ba1d9aec>Sign In/Sign Up</span></div>" : "<!---->") + " " + (_vm.jwtToken ? "<div class=\"chat-header__menuitem\" data-v-ba1d9aec><span class=\"svg\" data-v-ba1d9aec></span> <span class=\"label\" data-v-ba1d9aec>Orders</span></div>" : "<!---->"))], 2), _vm._ssrNode(" <div class=\"chat-header__menuitems\" data-v-ba1d9aec><div class=\"chat-header__menuitem\" data-v-ba1d9aec><span class=\"svg\" data-v-ba1d9aec></span></div> " + (_vm.jwtToken ? "<div class=\"chat-header__menuitem\" data-v-ba1d9aec><span class=\"svg\" data-v-ba1d9aec></span> <span class=\"label\" data-v-ba1d9aec>Signout</span></div>" : "<!---->") + "</div>")], 2)]) : _vm._e()], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./components/ChatHeader.vue?vue&type=template&id=ba1d9aec&scoped=true
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ChatHeader_vue_vue_type_style_index_0_id_ba1d9aec_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(47);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ChatHeader_vue_vue_type_style_index_0_id_ba1d9aec_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ChatHeader_vue_vue_type_style_index_0_id_ba1d9aec_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ChatHeader_vue_vue_type_style_index_0_id_ba1d9aec_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ChatHeader_vue_vue_type_style_index_0_id_ba1d9aec_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, "*[data-v-ba1d9aec],[data-v-ba1d9aec]:after,[data-v-ba1d9aec]:before{box-sizing:inherit;margin:0;padding:0}html[data-v-ba1d9aec]{background:#249b48;font-size:62.5%}@media only screen and (max-width:75em){html[data-v-ba1d9aec]{font-size:56.25%}}@media only screen and (max-width:56.25em){html[data-v-ba1d9aec]{font-size:55%}}@media only screen and (max-width:37.5em){html[data-v-ba1d9aec]{font-size:50%}}@media only screen and (min-width:112.5em){html[data-v-ba1d9aec]{font-size:65%}}body[data-v-ba1d9aec]{background:#249b48;box-sizing:border-box;display:none;font-family:\"Poppins\",sans-serif}@media only screen and (max-width:56.25em){body[data-v-ba1d9aec]{padding:0}}[data-v-ba1d9aec]::-moz-selection{background-color:#249b48;color:#fff}[data-v-ba1d9aec]::selection{background-color:#249b48;color:#fff}[data-v-ba1d9aec]::-webkit-scrollbar{height:8px;width:8px}[data-v-ba1d9aec]::-webkit-scrollbar-track{background:transparent}[data-v-ba1d9aec]::-webkit-scrollbar-thumb{background-color:#249b48;border:none;border-radius:10px}[data-v-ba1d9aec]::-webkit-scrollbar-thumb:hover{background-color:#1a7235}*[data-v-ba1d9aec]{scrollbar-color:#249b48 transparent;scrollbar-width:thin}@keyframes slideFadeInUp-ba1d9aec{0%{opacity:0;transform:translateY(20px)}to{opacity:1;transform:translateY(0)}}@keyframes slide-in-left-ba1d9aec{0%{opacity:0;transform:translateX(-100%)}to{opacity:1;transform:translateX(0)}}@keyframes float-ba1d9aec{0%{transform:translateY(0)}50%{transform:translateY(-10px)}to{transform:translateY(0)}}@keyframes spin-ba1d9aec{to{transform:rotate(1turn)}}.slide-in-left[data-v-ba1d9aec]{animation:slide-in-left-ba1d9aec .5s ease-out forwards}.button-primary[data-v-ba1d9aec]{background:#249b48;border:none;border-radius:1rem;color:#fff;font-weight:500;outline:none;padding:1rem}.transparent-button[data-v-ba1d9aec]{background:transparent;border:1px solid #249b48;color:#249b48}.disabled-btn[data-v-ba1d9aec]{opacity:.4}.floating-element[data-v-ba1d9aec]{animation:float-ba1d9aec 3s ease-in-out infinite;animation-delay:0s;transition:transform .2s ease}.no-scroll[data-v-ba1d9aec]{height:100vh!important;overflow:hidden!important}.spinner[data-v-ba1d9aec]{animation:spin-ba1d9aec 1s linear infinite;border:4px solid rgba(36,155,72,.3);border-radius:50%;border-top-color:#249b48;height:3rem;width:3rem}.spinner.path[data-v-ba1d9aec]{stroke:#249b48;stroke-linecap:round}.blur-effect[data-v-ba1d9aec]{filter:blur(3px)}.landing[data-v-ba1d9aec]{overflow-x:hidden}.landing__top[data-v-ba1d9aec]{background:#b6edf2;display:grid;grid-template-columns:repeat(2,1fr);height:100vh;left:0;position:fixed;top:0;width:100%}@media only screen and (max-width:56.25em){.landing__top[data-v-ba1d9aec]{display:flex}}.landing__topleft[data-v-ba1d9aec]{display:flex;justify-content:center}@media only screen and (max-width:56.25em){.landing__topleft[data-v-ba1d9aec]{display:block;width:100%}}.landing__topleft--auth[data-v-ba1d9aec]{padding:0 10rem;width:100rem}@media only screen and (max-width:56.25em){.landing__topleft--auth[data-v-ba1d9aec]{padding:0;width:auto}}.landing__topright[data-v-ba1d9aec],.landing__topright--img[data-v-ba1d9aec]{align-items:center;display:flex;justify-content:center}.landing__topright--img[data-v-ba1d9aec]{transform:scale(1.1);width:100rem}.landing__topright--img img[data-v-ba1d9aec]{height:100%;-o-object-fit:contain;object-fit:contain;width:100%}@media only screen and (max-width:56.25em){.landing__topright[data-v-ba1d9aec]{display:none}}.landing__content[data-v-ba1d9aec]{background:#249b48;margin-top:90rem;position:relative}.landing__seemore[data-v-ba1d9aec]{bottom:10rem;display:flex;justify-content:center;left:0;position:absolute;width:100%}.landing__seemore button[data-v-ba1d9aec]{background:transparent;border:1px solid #fff;border-radius:3rem;color:#fff;cursor:pointer;font-size:1.4rem;font-weight:600;padding:1rem 4rem}.landing__cloud[data-v-ba1d9aec]{bottom:0;height:34rem;position:absolute;transform:scale(1.1);width:100vw;z-index:3}.landing__cloud img[data-v-ba1d9aec]{height:100%;-o-object-fit:cover;object-fit:cover;width:100%}.chat-header[data-v-ba1d9aec]{align-items:center;display:flex;justify-content:space-between;padding:3rem}@media only screen and (max-width:37.5em){.chat-header[data-v-ba1d9aec]{padding:2rem}}.chat-header__name[data-v-ba1d9aec],.chat-header__name span.svg[data-v-ba1d9aec]{align-items:center;display:flex}.chat-header__name span.svg[data-v-ba1d9aec]{margin-right:.5rem}.chat-header__name span.svg svg[data-v-ba1d9aec]{height:2rem;width:2rem;fill:#249b48;color:#249b48}.chat-header__name span.label[data-v-ba1d9aec]{align-items:center;color:#249b48;display:flex;font-size:2rem;font-weight:600}@media only screen and (max-width:56.25em){.chat-header__right--cart[data-v-ba1d9aec]{display:none}}.chat-header__left--logo[data-v-ba1d9aec]{height:3rem}.chat-header__left--logo.bottom-1rem[data-v-ba1d9aec]{margin-bottom:5rem}.chat-header__left--logo img[data-v-ba1d9aec]{height:100%;-o-object-fit:cover;object-fit:cover;width:auto}.chat-header__left--logo.green[data-v-ba1d9aec]{height:3.5rem}.chat-header__burger[data-v-ba1d9aec]{display:flex;flex-direction:column;height:2.5rem;justify-content:space-between}.chat-header__burger span[data-v-ba1d9aec]{background:#249b48;border-radius:1rem;display:inline-block;flex-shrink:0;height:.35rem;margin:.2rem 0;width:3rem}.chat-header__burger span[data-v-ba1d9aec]:nth-child(2){height:.35rem;width:2rem}.chat-header__burger.unauth span[data-v-ba1d9aec]{background:#fff}.chat-header__burger.green span[data-v-ba1d9aec]{background:#249b48}.chat-header__menu[data-v-ba1d9aec]{background:rgba(0,0,0,.6);height:100vh;left:0;overflow:hidden;overflow-y:scroll;position:fixed;top:0;width:100vw}.chat-header__menu.auth[data-v-ba1d9aec]{background:transparent;box-shadow:20px 0 30px -10px rgba(36,155,72,.1);width:auto}@media only screen and (max-width:56.25em){.chat-header__menu[data-v-ba1d9aec],.chat-header__menu.auth[data-v-ba1d9aec]{background:rgba(0,0,0,.6);box-shadow:none;overflow:hidden;overflow-y:scroll;width:100vw}}.chat-header__menuitem[data-v-ba1d9aec]{cursor:pointer;font-size:1.4rem;font-weight:500;margin-bottom:3rem;-webkit-text-decoration:none;text-decoration:none}@media only screen and (max-width:56.25em){.chat-header__menuitem[data-v-ba1d9aec]{font-size:1.8rem}}.chat-header__menuitem span[data-v-ba1d9aec]{-webkit-text-decoration:none;text-decoration:none}.chat-header__menubody[data-v-ba1d9aec]{background:#fff;color:#000;display:flex;flex-direction:column;height:100vh;justify-content:space-between;padding:2rem 2rem 14rem;width:35rem}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
