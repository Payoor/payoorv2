...
module.exports.__inject__ = function (context) {
  add("b87e1040", content, true, context)
};
...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_options_vue_vue_type_style_index_0_id_3cf8a0e4_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(124);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_options_vue_vue_type_style_index_0_id_3cf8a0e4_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_options_vue_vue_type_style_index_0_id_3cf8a0e4_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_options_vue_vue_type_style_index_0_id_3cf8a0e4_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_options_vue_vue_type_style_index_0_id_3cf8a0e4_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, "*[data-v-3cf8a0e4],[data-v-3cf8a0e4]:after,[data-v-3cf8a0e4]:before{box-sizing:inherit;margin:0;padding:0}html[data-v-3cf8a0e4]{background:#249b48;font-size:62.5%}@media only screen and (max-width:75em){html[data-v-3cf8a0e4]{font-size:56.25%}}@media only screen and (max-width:56.25em){html[data-v-3cf8a0e4]{font-size:55%}}@media only screen and (max-width:37.5em){html[data-v-3cf8a0e4]{font-size:50%}}@media only screen and (min-width:112.5em){html[data-v-3cf8a0e4]{font-size:65%}}body[data-v-3cf8a0e4]{background:#249b48;box-sizing:border-box;display:none;font-family:\"Poppins\",sans-serif}@media only screen and (max-width:56.25em){body[data-v-3cf8a0e4]{padding:0}}[data-v-3cf8a0e4]::-moz-selection{background-color:#249b48;color:#fff}[data-v-3cf8a0e4]::selection{background-color:#249b48;color:#fff}[data-v-3cf8a0e4]::-webkit-scrollbar{height:8px;width:8px}[data-v-3cf8a0e4]::-webkit-scrollbar-track{background:transparent}[data-v-3cf8a0e4]::-webkit-scrollbar-thumb{background-color:#249b48;border:none;border-radius:10px}[data-v-3cf8a0e4]::-webkit-scrollbar-thumb:hover{background-color:#1a7235}*[data-v-3cf8a0e4]{scrollbar-color:#249b48 transparent;scrollbar-width:thin}@keyframes slideFadeInUp-3cf8a0e4{0%{opacity:0;transform:translateY(20px)}to{opacity:1;transform:translateY(0)}}@keyframes slide-in-left-3cf8a0e4{0%{opacity:0;transform:translateX(-100%)}to{opacity:1;transform:translateX(0)}}@keyframes float-3cf8a0e4{0%{transform:translateY(0)}50%{transform:translateY(-10px)}to{transform:translateY(0)}}.slide-in-left[data-v-3cf8a0e4]{animation:slide-in-left-3cf8a0e4 .5s ease-out forwards}.button-primary[data-v-3cf8a0e4]{background:#249b48;border:none;border-radius:1rem;color:#fff;font-weight:500;outline:none;padding:1rem}.transparent-button[data-v-3cf8a0e4]{background:transparent;border:1px solid #249b48;color:#249b48}.disabled-btn[data-v-3cf8a0e4]{opacity:.4}.floating-element[data-v-3cf8a0e4]{animation:float-3cf8a0e4 3s ease-in-out infinite;animation-delay:0s;transition:transform .2s ease}.no-scroll[data-v-3cf8a0e4]{height:100vh!important;overflow:hidden!important}.spinner[data-v-3cf8a0e4]{animation:spin-3cf8a0e4 1s linear infinite;border:4px solid rgba(36,155,72,.3);border-radius:50%;border-top-color:#249b48;height:3rem;width:3rem}.spinner.path[data-v-3cf8a0e4]{stroke:#249b48;stroke-linecap:round}.blur-effect[data-v-3cf8a0e4]{filter:blur(3px)}.error-message[data-v-3cf8a0e4]{animation:slideFadeInUp-3cf8a0e4 .5s ease-out forwards;background:#fff;border-radius:1rem;bottom:15rem;color:red;font-size:1.48rem;font-weight:500;left:0;line-height:2.1rem;margin:2rem 16px;padding:2rem;position:fixed;right:0;z-index:30}.error-message-timeout-bar[data-v-3cf8a0e4]{background-color:#249b48;bottom:0;height:4px;left:0;position:absolute;transition:width 4s linear;width:100%}.landing[data-v-3cf8a0e4]{overflow-x:hidden}.landing__top[data-v-3cf8a0e4]{background:#b6edf2;display:grid;grid-template-columns:repeat(2,1fr);height:100vh;left:0;position:fixed;top:0;width:100%}@media only screen and (max-width:56.25em){.landing__top[data-v-3cf8a0e4]{display:flex}}.landing__topleft[data-v-3cf8a0e4]{display:flex;justify-content:center}@media only screen and (max-width:56.25em){.landing__topleft[data-v-3cf8a0e4]{display:block;width:100%}}.landing__topleft--auth[data-v-3cf8a0e4]{padding:0 10rem;width:100rem}@media only screen and (max-width:56.25em){.landing__topleft--auth[data-v-3cf8a0e4]{padding:0;width:auto}}.landing__topright[data-v-3cf8a0e4],.landing__topright--img[data-v-3cf8a0e4]{align-items:center;display:flex;justify-content:center}.landing__topright--img[data-v-3cf8a0e4]{transform:scale(1.1);width:100rem}.landing__topright--img img[data-v-3cf8a0e4]{height:100%;-o-object-fit:contain;object-fit:contain;width:100%}@media only screen and (max-width:56.25em){.landing__topright[data-v-3cf8a0e4]{display:none}}.landing__content[data-v-3cf8a0e4]{background:#249b48;margin-top:90rem;position:relative}.landing__seemore[data-v-3cf8a0e4]{bottom:10rem;display:flex;justify-content:center;left:0;position:absolute;width:100%}.landing__seemore button[data-v-3cf8a0e4]{background:transparent;border:1px solid #fff;border-radius:3rem;color:#fff;cursor:pointer;font-size:1.4rem;font-weight:600;padding:1rem 4rem}.landing__cloud[data-v-3cf8a0e4]{bottom:0;height:34rem;position:absolute;transform:scale(1.1);width:100vw;z-index:3}.landing__cloud img[data-v-3cf8a0e4]{height:100%;-o-object-fit:cover;object-fit:cover;width:100%}.chatoptions[data-v-3cf8a0e4]{height:100vh;overflow:hidden;overflow-y:scroll;padding:4rem 2rem 19rem;z-index:10}.chatoptions[data-v-3cf8a0e4],.chatoptions__header[data-v-3cf8a0e4]{background:#fff;left:0;position:fixed;top:0;width:100vw}.chatoptions__header[data-v-3cf8a0e4]{z-index:6}.chatoptions__header.auth[data-v-3cf8a0e4],.chatoptions__header.unauth[data-v-3cf8a0e4]{background:transparent}@media only screen and (max-width:56.25em){.chatoptions__header.auth[data-v-3cf8a0e4]{background:#fff}}.chatoptions__options[data-v-3cf8a0e4]{margin-top:3rem}.chatoptions__description[data-v-3cf8a0e4]{border-top:1px solid #eee;margin-top:2rem;padding:1rem 0}.chatoptions__description .description__title[data-v-3cf8a0e4]{color:#000;font-size:1.6rem;font-weight:700;margin-bottom:1rem}.chatoptions__description .description__text[data-v-3cf8a0e4]{color:#555;font-size:1.4rem;line-height:1.6}.chatoptions__content[data-v-3cf8a0e4]{display:flex;justify-content:center}.chatoptions__content--body[data-v-3cf8a0e4]{width:60rem}@media only screen and (max-width:56.25em){.chatoptions__content--body[data-v-3cf8a0e4]{width:100%}}.chatoptions__loading[data-v-3cf8a0e4]{align-items:center;display:flex;justify-content:center;padding:5rem 0}.chatoptions__tags[data-v-3cf8a0e4]{border-bottom:1px solid #fff;border-top:1px solid #fff;display:flex;flex-wrap:wrap;gap:.8rem;margin-top:2rem;padding:1rem 0}.chatoptions__tag-pill[data-v-3cf8a0e4]{align-items:center;background-color:rgba(36,155,72,.1);border-radius:20px;color:#249b48;display:inline-flex;font-size:1.3rem;font-weight:500;justify-content:center;padding:.6rem 1.2rem;text-transform:capitalize;white-space:nowrap}.chatoptions__bottom[data-v-3cf8a0e4]{background:#fff;bottom:0;display:flex;justify-content:center;left:0;padding:1rem 1rem 2rem;position:fixed;width:100%;z-index:4}.chatoptions__bottom.column[data-v-3cf8a0e4]{flex-direction:column}@media only screen and (max-width:56.25em){.chatoptions__bottom[data-v-3cf8a0e4]{display:block}}.chatoptions__bottom button[data-v-3cf8a0e4]{font-size:2rem;padding:2rem;width:100%}.chatoptions__bottom button.spacebetween[data-v-3cf8a0e4]{display:flex;justify-content:space-between}.chatoptions__bottom button.transparent-button[data-v-3cf8a0e4]{margin-bottom:2rem}.chatoptions__bottom .button-primary[data-v-3cf8a0e4]{align-items:center;display:flex;gap:.5rem;justify-content:center}.loader[data-v-3cf8a0e4]{animation:spin-3cf8a0e4 1s linear infinite;border:.4rem solid #f3f3f3;border-radius:50%;border-top-color:#fff;height:2.5rem;width:2.5rem}.ml-1[data-v-3cf8a0e4]{margin-left:.5rem}@keyframes spin-3cf8a0e4{0%{transform:rotate(0deg)}to{transform:rotate(1turn)}}.button-primary[disabled][data-v-3cf8a0e4]{cursor:not-allowed;opacity:.7}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/options.vue?vue&type=template&id=3cf8a0e4&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "chatoptions"
  }, [_vm._ssrNode("<div class=\"chatoptions__content\" data-v-3cf8a0e4>", "</div>", [_vm._ssrNode("<div class=\"chatoptions__content--body\" data-v-3cf8a0e4>", "</div>", [_vm._ssrNode("<div class=\"chatoptions__header\" data-v-3cf8a0e4>", "</div>", [_c('ChatHeader', {
    attrs: {
  ...
  })], 1)])]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"chatoptions__content\" data-v-3cf8a0e4>", "</div>", [_vm._ssrNode("<div class=\"chatoptions__content--body\" data-v-3cf8a0e4>", "</div>", [_vm._ssrNode("<div class=\"chatoptions__options\" data-v-3cf8a0e4>", "</div>", [_vm.loading ? _vm._ssrNode("<div class=\"chatoptions__loading\" data-v-3cf8a0e4>", "</div>", [_c('LoadingAnimation')], 1) : _vm._ssrNode("<div data-v-3cf8a0e4>", "</div>", _vm._l(_vm.variants, function (variant) {
    return _vm._ssrNode("<div data-v-3cf8a0e4>", "</div>", [_c('ChatOption', {
      attrs: {
        "data": {
          ...variant,
  ...
  }), 0), _vm._ssrNode(" " + (_vm.productTags && _vm.productTags.length > 0 ? "<div class=\"chatoptions__tags\" data-v-3cf8a0e4>" + _vm._ssrList(_vm.productTags, function (tag, index) {
    return "<span class=\"chatoptions__tag-pill\" data-v-3cf8a0e4>" + _vm._ssrEscape("\n                        " + _vm._s(tag) + "\n                    ") + "</span>";
  }) + "</div>" : "<!---->") + " <div class=\"chatoptions__description\" data-v-3cf8a0e4><div class=\"chatoptions__content--body\" data-v-3cf8a0e4><h2 class=\"description__title\" data-v-3cf8a0e4>Product Description</h2> <p class=\"description__text\" data-v-3cf8a0e4>" + _vm._ssrEscape("\n                            " + _vm._s(_vm.product.productDescription || `This product comes in multiple variants. Select the
                            one that
                            best fits your needs. Each
                            variant is carefully crafted to ensure the best quality and customer satisfaction.`) + "\n                        ") + "</p></div></div>")], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"chatoptions__bottom\" data-v-3cf8a0e4>", "</div>", [_vm._ssrNode("<div class=\"chatoptions__content--body\" data-v-3cf8a0e4>", "</div>", [_vm._ssrNode("<button class=\"button-primary transparent-button\" data-v-3cf8a0e4><span data-v-3cf8a0e4>Continue Shopping</span></button> "), _vm.cartTotal === 0 ? _vm._ssrNode("<button" + _vm._ssrAttr("disabled", _vm.checkoutLoading) + " class=\"button-primary spacebetween disabled-btn\" data-v-3cf8a0e4>", "</button>", [_vm._ssrNode("<span data-v-3cf8a0e4>Proceed to Checkout</span> "), _vm.checkoutLoading ? _vm._ssrNode("<span class=\"loader ml-1\" data-v-3cf8a0e4>", "</span>") : _c('CartButton', {
    attrs: {
      "showicon": false
    }
  })], 2) : _vm._e(), _vm._ssrNode(" "), _vm.cartTotal > 0 ? _vm._ssrNode("<button" + _vm._ssrAttr("disabled", _vm.checkoutLoading) + " class=\"button-primary spacebetween\" data-v-3cf8a0e4>", "</button>", [_vm._ssrNode("<span data-v-3cf8a0e4>Proceed to Checkout</span> "), _vm.checkoutLoading ? _vm._ssrNode("<span class=\"loader ml-1\" data-v-3cf8a0e4>", "</span>") : _c('CartButton', {
    attrs: {
      "showicon": false
    }
  })], 2) : _vm._e()], 2)])], 2)])], 2);
...
// CONCATENATED MODULE: ./pages/options.vue?vue&type=template&id=3cf8a0e4&scoped=true
...
/* harmony default export */ var optionsvue_type_script_lang_js = ({
  ...
  methods: {
    ...
    async getProduct() {
      ...
      try {
        const response = await fetch(`${api["b" /* serverurl */]}/shopper/getproduct?mongooseid=${productId}`, {
          method: 'GET',
          headers: {
    ...
    async getOptions() {
      ...
      try {
        const response = await fetch(`${api["b" /* serverurl */]}/shopper/getoptions?mongooseid=${optionsId}`, {
          method: 'GET',
          headers: {
            Authorization: `Bearer ${token}`,
            'Content-Type': 'application/json',
...
installComponents(component, {ChatHeader: __webpack_require__(51).default,LoadingAnimation: __webpack_require__(54).default,ChatOption: __webpack_require__(71).default,CartButton: __webpack_require__(47).default})
