...
module.exports.__inject__ = function (context) {
  add("37318571", content, true, context)
};
...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_options_vue_vue_type_style_index_0_id_c2647cb8_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(120);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_options_vue_vue_type_style_index_0_id_c2647cb8_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_options_vue_vue_type_style_index_0_id_c2647cb8_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_options_vue_vue_type_style_index_0_id_c2647cb8_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_options_vue_vue_type_style_index_0_id_c2647cb8_prod_lang_scss_scoped_true__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, "*[data-v-c2647cb8],[data-v-c2647cb8]:after,[data-v-c2647cb8]:before{box-sizing:inherit;margin:0;padding:0}html[data-v-c2647cb8]{background:#249b48;font-size:62.5%}@media only screen and (max-width:75em){html[data-v-c2647cb8]{font-size:56.25%}}@media only screen and (max-width:56.25em){html[data-v-c2647cb8]{font-size:55%}}@media only screen and (max-width:37.5em){html[data-v-c2647cb8]{font-size:50%}}@media only screen and (min-width:112.5em){html[data-v-c2647cb8]{font-size:65%}}body[data-v-c2647cb8]{background:#249b48;box-sizing:border-box;display:none;font-family:\"Poppins\",sans-serif}@media only screen and (max-width:56.25em){body[data-v-c2647cb8]{padding:0}}[data-v-c2647cb8]::-moz-selection{background-color:#249b48;color:#fff}[data-v-c2647cb8]::selection{background-color:#249b48;color:#fff}[data-v-c2647cb8]::-webkit-scrollbar{height:8px;width:8px}[data-v-c2647cb8]::-webkit-scrollbar-track{background:transparent}[data-v-c2647cb8]::-webkit-scrollbar-thumb{background-color:#249b48;border:none;border-radius:10px}[data-v-c2647cb8]::-webkit-scrollbar-thumb:hover{background-color:#1a7235}*[data-v-c2647cb8]{scrollbar-color:#249b48 transparent;scrollbar-width:thin}@keyframes slideFadeInUp-c2647cb8{0%{opacity:0;transform:translateY(20px)}to{opacity:1;transform:translateY(0)}}@keyframes slide-in-left-c2647cb8{0%{opacity:0;transform:translateX(-100%)}to{opacity:1;transform:translateX(0)}}@keyframes float-c2647cb8{0%{transform:translateY(0)}50%{transform:translateY(-10px)}to{transform:translateY(0)}}.slide-in-left[data-v-c2647cb8]{animation:slide-in-left-c2647cb8 .5s ease-out forwards}.button-primary[data-v-c2647cb8]{background:#249b48;border:none;border-radius:1rem;color:#fff;font-weight:500;outline:none;padding:1rem}.transparent-button[data-v-c2647cb8]{background:transparent;border:1px solid #249b48;color:#249b48}.disabled-btn[data-v-c2647cb8]{opacity:.4}.floating-element[data-v-c2647cb8]{animation:float-c2647cb8 3s ease-in-out infinite;animation-delay:0s;transition:transform .2s ease}.no-scroll[data-v-c2647cb8]{height:100vh!important;overflow:hidden!important}.spinner[data-v-c2647cb8]{animation:spin-c2647cb8 1s linear infinite;border:4px solid rgba(36,155,72,.3);border-radius:50%;border-top-color:#249b48;height:3rem;width:3rem}.spinner.path[data-v-c2647cb8]{stroke:#249b48;stroke-linecap:round}.blur-effect[data-v-c2647cb8]{filter:blur(3px)}.error-message[data-v-c2647cb8]{animation:slideFadeInUp-c2647cb8 .5s ease-out forwards;background:#fff;border-radius:1rem;bottom:15rem;color:red;font-size:1.48rem;font-weight:500;left:0;line-height:2.1rem;margin:2rem 16px;padding:2rem;position:fixed;right:0;z-index:30}.error-message-timeout-bar[data-v-c2647cb8]{background-color:#249b48;bottom:0;height:4px;left:0;position:absolute;transition:width 4s linear;width:100%}.landing[data-v-c2647cb8]{overflow-x:hidden}.landing__top[data-v-c2647cb8]{background:#b6edf2;display:grid;grid-template-columns:repeat(2,1fr);height:100vh;left:0;position:fixed;top:0;width:100%}@media only screen and (max-width:56.25em){.landing__top[data-v-c2647cb8]{display:flex}}.landing__topleft[data-v-c2647cb8]{display:flex;justify-content:center}@media only screen and (max-width:56.25em){.landing__topleft[data-v-c2647cb8]{display:block;width:100%}}.landing__topleft--auth[data-v-c2647cb8]{padding:0 10rem;width:100rem}@media only screen and (max-width:56.25em){.landing__topleft--auth[data-v-c2647cb8]{padding:0;width:auto}}.landing__topright[data-v-c2647cb8],.landing__topright--img[data-v-c2647cb8]{align-items:center;display:flex;justify-content:center}.landing__topright--img[data-v-c2647cb8]{transform:scale(1.1);width:100rem}.landing__topright--img img[data-v-c2647cb8]{height:100%;-o-object-fit:contain;object-fit:contain;width:100%}@media only screen and (max-width:56.25em){.landing__topright[data-v-c2647cb8]{display:none}}.landing__content[data-v-c2647cb8]{background:#249b48;margin-top:90rem;position:relative}.landing__seemore[data-v-c2647cb8]{bottom:10rem;display:flex;justify-content:center;left:0;position:absolute;width:100%}.landing__seemore button[data-v-c2647cb8]{background:transparent;border:1px solid #fff;border-radius:3rem;color:#fff;cursor:pointer;font-size:1.4rem;font-weight:600;padding:1rem 4rem}.landing__cloud[data-v-c2647cb8]{bottom:0;height:34rem;position:absolute;transform:scale(1.1);width:100vw;z-index:3}.landing__cloud img[data-v-c2647cb8]{height:100%;-o-object-fit:cover;object-fit:cover;width:100%}.chatoptions[data-v-c2647cb8]{height:100vh;overflow:hidden;overflow-y:scroll;padding:4rem 2rem 19rem;z-index:10}.chatoptions[data-v-c2647cb8],.chatoptions__header[data-v-c2647cb8]{background:#fff;left:0;position:fixed;top:0;width:100vw}.chatoptions__header[data-v-c2647cb8]{z-index:6;z-index:3}.chatoptions__header.auth[data-v-c2647cb8],.chatoptions__header.unauth[data-v-c2647cb8]{background:transparent}@media only screen and (max-width:56.25em){.chatoptions__header.auth[data-v-c2647cb8]{background:#fff}}.chatoptions__options[data-v-c2647cb8]{margin-top:3rem}.chatoptions__description[data-v-c2647cb8]{border-top:1px solid #eee;margin-top:2rem;padding:1rem 0}.chatoptions__description .description__title[data-v-c2647cb8]{color:#000;font-size:1.6rem;font-weight:700;margin-bottom:1rem}.chatoptions__description .description__text[data-v-c2647cb8]{color:#555;font-size:1.4rem;line-height:1.6}.chatoptions__content[data-v-c2647cb8]{display:flex;justify-content:center}.chatoptions__content--body[data-v-c2647cb8]{width:60rem}@media only screen and (max-width:56.25em){.chatoptions__content--body[data-v-c2647cb8]{width:100%}}.chatoptions__loading[data-v-c2647cb8]{align-items:center;display:flex;justify-content:center;padding:5rem 0}.chatoptions__tags[data-v-c2647cb8]{border-bottom:1px solid #fff;border-top:1px solid #fff;display:flex;flex-wrap:wrap;gap:.8rem;margin-top:2rem;padding:1rem 0}.chatoptions__tag-pill[data-v-c2647cb8]{align-items:center;background-color:rgba(36,155,72,.1);border-radius:20px;color:#249b48;display:inline-flex;font-size:1.3rem;font-weight:500;justify-content:center;padding:.6rem 1.2rem;text-transform:capitalize;white-space:nowrap}.chatoptions__bottom[data-v-c2647cb8]{background:#fff;bottom:0;display:flex;justify-content:center;left:0;padding:1rem 1rem 2rem;position:fixed;width:100%;z-index:4}.chatoptions__bottom.column[data-v-c2647cb8]{flex-direction:column}@media only screen and (max-width:56.25em){.chatoptions__bottom[data-v-c2647cb8]{display:block}}.chatoptions__bottom button[data-v-c2647cb8]{font-size:2rem;padding:2rem;width:100%}.chatoptions__bottom button.spacebetween[data-v-c2647cb8]{display:flex;justify-content:space-between}.chatoptions__bottom button.transparent-button[data-v-c2647cb8]{margin-bottom:2rem}.chatoptions__bottom .button-primary[data-v-c2647cb8]{align-items:center;display:flex;gap:.5rem;justify-content:center}.loader[data-v-c2647cb8]{animation:spin-c2647cb8 1s linear infinite;border:.4rem solid #f3f3f3;border-radius:50%;border-top-color:#fff;height:2.5rem;width:2.5rem}.ml-1[data-v-c2647cb8]{margin-left:.5rem}@keyframes spin-c2647cb8{0%{transform:rotate(0deg)}to{transform:rotate(1turn)}}.button-primary[disabled][data-v-c2647cb8]{cursor:not-allowed;opacity:.7}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/options.vue?vue&type=template&id=c2647cb8&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "chatoptions"
  }, [_vm._ssrNode("<div class=\"chatoptions__content\" data-v-c2647cb8>", "</div>", [_vm._ssrNode("<div class=\"chatoptions__content--body\" data-v-c2647cb8>", "</div>", [_vm._ssrNode("<div class=\"chatoptions__header\" data-v-c2647cb8>", "</div>", [_c('ChatHeader', {
    attrs: {
  ...
  })], 1)])]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"chatoptions__content\" data-v-c2647cb8>", "</div>", [_vm._ssrNode("<div class=\"chatoptions__content--body\" data-v-c2647cb8>", "</div>", [_vm._ssrNode("<div class=\"chatoptions__options\" data-v-c2647cb8>", "</div>", [_vm.loading ? _vm._ssrNode("<div class=\"chatoptions__loading\" data-v-c2647cb8>", "</div>", [_c('LoadingAnimation')], 1) : _vm._ssrNode("<div data-v-c2647cb8>", "</div>", _vm._l(_vm.variants, function (variant) {
    return _vm._ssrNode("<div data-v-c2647cb8>", "</div>", [_c('ChatOption', {
      attrs: {
        "data": {
          ...variant,
  ...
  }), 0), _vm._ssrNode(" " + (_vm.productTags && _vm.productTags.length > 0 ? "<div class=\"chatoptions__tags\" data-v-c2647cb8>" + _vm._ssrList(_vm.productTags, function (tag, index) {
    return "<span class=\"chatoptions__tag-pill\" data-v-c2647cb8>" + _vm._ssrEscape("\n                        " + _vm._s(tag) + "\n                    ") + "</span>";
  }) + "</div>" : "<!---->") + " <div class=\"chatoptions__description\" data-v-c2647cb8><div class=\"chatoptions__content--body\" data-v-c2647cb8><h2 class=\"description__title\" data-v-c2647cb8>Product Description</h2> <p class=\"description__text\" data-v-c2647cb8>" + _vm._ssrEscape("\n                            " + _vm._s(_vm.product.productDescription || `This product comes in multiple variants. Select the
                            one that
                            best fits your needs. Each
                            variant is carefully crafted to ensure the best quality and customer satisfaction.`) + "\n                        ") + "</p></div></div>")], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"chatoptions__bottom\" data-v-c2647cb8>", "</div>", [_vm._ssrNode("<div class=\"chatoptions__content--body\" data-v-c2647cb8>", "</div>", [_vm._ssrNode("<button class=\"button-primary transparent-button\" data-v-c2647cb8><span data-v-c2647cb8>Continue Shopping</span></button> "), _vm.cartTotal === 0 ? _vm._ssrNode("<button" + _vm._ssrAttr("disabled", _vm.checkoutLoading) + " class=\"button-primary spacebetween disabled-btn\" data-v-c2647cb8>", "</button>", [_vm._ssrNode("<span data-v-c2647cb8>Proceed to Checkout</span> "), _vm.checkoutLoading ? _vm._ssrNode("<span class=\"loader ml-1\" data-v-c2647cb8>", "</span>") : _c('CartButton', {
    attrs: {
      "showicon": false
    }
  })], 2) : _vm._e(), _vm._ssrNode(" "), _vm.cartTotal > 0 ? _vm._ssrNode("<button" + _vm._ssrAttr("disabled", _vm.checkoutLoading) + " class=\"button-primary spacebetween\" data-v-c2647cb8>", "</button>", [_vm._ssrNode("<span data-v-c2647cb8>Proceed to Checkout</span> "), _vm.checkoutLoading ? _vm._ssrNode("<span class=\"loader ml-1\" data-v-c2647cb8>", "</span>") : _c('CartButton', {
    attrs: {
      "showicon": false
    }
  })], 2) : _vm._e()], 2)])], 2)])], 2);
...
// CONCATENATED MODULE: ./pages/options.vue?vue&type=template&id=c2647cb8&scoped=true
...
/* harmony default export */ var optionsvue_type_script_lang_js = ({
  ...
  methods: {
    ...
    async getProduct() {
      ...
      try {
        const response = await fetch(`${api["b" /* serverurl */]}/shopper/getproduct?mongooseid=${this.$route.query.currentproduct}`, {
          method: 'GET',
          headers: {
    ...
    async getOptions() {
      ...
      const token = await this.getValidToken();
      try {
        const response = await fetch(`${api["b" /* serverurl */]}/shopper/getoptions?mongooseid=${this.$route.query.currentproduct}`, {
          method: 'GET',
          headers: {
            Authorization: `Bearer ${token}`,
            'Content-Type': 'application/json',
...
installComponents(component, {ChatHeader: __webpack_require__(51).default,LoadingAnimation: __webpack_require__(54).default,ChatOption: __webpack_require__(71).default,CartButton: __webpack_require__(48).default})
